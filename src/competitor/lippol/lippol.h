...
template<class KEY_TYPE, class PAYLOAD_TYPE>
void LIPPOLInterface<KEY_TYPE, PAYLOAD_TYPE>::bulk_load(std::pair <KEY_TYPE, PAYLOAD_TYPE> *key_value, size_t num, Param *param) {
...
template<class KEY_TYPE, class PAYLOAD_TYPE>
size_t LIPPOLInterface<KEY_TYPE, PAYLOAD_TYPE>::scan(KEY_TYPE key_low_bound,
                                                     size_t key_num,
